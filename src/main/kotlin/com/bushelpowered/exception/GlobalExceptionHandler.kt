...
class GlobalExceptionHandler {
    ...
    fun handlePokemonNotFoundException(ex: PokemonNotFoundException): String {
        return when (ex.message) {
            "getPokemonByID" -> "Pokemon with this id not found, please try again."
            "getPokemonByName" -> "Pokemon with this name not found, please try again."
            else -> "Pokemon with this description not found, please try again."
        }
    }
